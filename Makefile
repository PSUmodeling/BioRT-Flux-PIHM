...
biort-flux-pihm:		## Compile BioRT-Flux-PIHM (Flux-PIHM with BioReactive Transport module)
...
clean:			## Clean executables and objects
	...
	@echo "... Cleaning ..."
	@echo
	@$(RM) $(SRCDIR)/*.o $(SRCDIR)/*/*.o $(CYCLES_PATH)/*.o *~ pihm pihm-fbr biort-flux-pihm flux-pihm-bgc flux-pihm-cycles